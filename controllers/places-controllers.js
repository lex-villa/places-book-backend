...
const getPlaceById = async (req, res, next) => {
    ...
    res.json({ place: place.toObject({ getters: true }) }); // getters true is for convert _id => id
};
...
const createPlace = async (req, res, next) => {
    ...
    const createdPlace = new Place({
        ...
        image: 'https://i.pinimg.com/originals/bc/be/60/bcbe605c9235c26f6fbf865f17c1582c.jpg',
        creator
    });
